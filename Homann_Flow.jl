...
md"_MAE 5943 Homework 4, version 1_"

# ╔═╡ 59909ca0-08e3-11eb-3348-41080f6a2bd8
md"""

## **Homework 4** - _Homann Flow_
`MAE 5943`, `Fall 2020`

#### **Description:**

This notebook computes the Homann Flow (axisymmetric stagnation point flow)

		homann(ηmax, N, itermax, ϵProfile, ϵBC)

If the arguments are missing, it will use the default values.
    
		homann(ηmax=10, N=30, itermax=40, ϵProfile=1e-6, ϵBC=1e-6)


#### **Homann Equation**
Stagnation point flow problem towards an axisymmetric body such as sphere can be represented using the ordinary differential equation (ODE) below:
...
Please see the lecture notes for [more information] (https://teams.microsoft.com/l/file/23E6AE17-30EB-418E-9C34-66086B8E6E3E?tenantId=2a69c91d-e849-4e34-a230-cdf8b27e1964&fileType=pdf&objectUrl=https%3A%2F%2Fostatemailokstate.sharepoint.com%2Fsites%2FSTW_MAE_5943_UNSTEADY_AERODYNAMICS%2FShared%20Documents%2FWeek%2001%20-%20Introduction%2F07_MAE_5943_Homann_Flow.pdf&baseUrl=https%3A%2F%2Fostatemailokstate.sharepoint.com%2Fsites%2FSTW_MAE_5943_UNSTEADY_AERODYNAMICS&serviceName=teams&threadId=19:bcec5825f6c440bfada9e3f6b9ea8555@thread.tacv2&messageId=1600463467662&groupId=ca352ade-ad9b-455f-a3a9-0c53f6111fc3) on the derivation of the ODE and numerical solution method.
...
"""
Computes the Homann Flow (Two-dimensional stagnation point flow)
...
"""
function homann(ηmax=10, N=30, itermax=40, ϵProfile=1e-6, ϵBC=1e-6)
...
plot([h5, h10, h20], [η5, η10, η20],
        title = "Homann Flow - Effect of Viscous Layer Height",
...
begin
	ηN10, hN10 = homann(10, 10);
	ηN20, hN20 = homann(10, 20);
	ηN40, hN40 = homann(10, 40);
	ηN80, hN80 = homann(10, 80);
end
...
plot([hN10, hN20, hN40, hN80], [ηN10, ηN20, ηN40, ηN80],
        seriestype = :scatter,    
        title = "Homann Flow - Effect of Grid Resolution",
